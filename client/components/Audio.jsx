  ...
  render() {
    if (this.state.loading) {
      ...
      <div className='audioSample'>
        <button>
        <img src="https://hr-rpt-audible.s3-us-west-1.amazonaws.com/loading.gif"></img>
        </button>
      </div>
      )
    }
    if (this.state.playing) {
      ...
      <div className='audioSample'>
        ...
        <img src="https://hr-rpt-audible.s3-us-west-1.amazonaws.com/pause.png"></img> {this.state.time}
        </button>
      </div>
      )
    }
    if (this.state.played) {
      return (
        ...
        <img src="https://hr-rpt-audible.s3-us-west-1.amazonaws.com/play.png"></img> {this.state.time}
        </button>
      </div>
      )
    }
    return (
      <div className='audioSample'>
      <button onClick={this.playAudioSample}>
      <img src="https://hr-rpt-audible.s3-us-west-1.amazonaws.com/play.png"></img> sample
      </button>
    </div>
    )
  }
